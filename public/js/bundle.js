    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alert.showAlert)('error', 'Error logging out! Try later.');
        case 3:
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v2/users/updatePassword' : 'http://127.0.0.1:3000/api/v2/users/updateMe';
          _context.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var getStripe = function getStripe() {
  if (!stripePromise) {
    stripePromise = (0, _stripeJs.loadStripe)('pk_test_51RzYMVDWt47WmjXIftKo1YWaz8YcIJDdaJnvB8EuzWbtxMa9Hau2XLPohvFxLhDzKtQbLStPW0nX2UVnc4ViMKif00Ulos2MZT');
  }
  return stripePromise;
};
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("http://127.0.0.1:3000/api/v2/bookings/checkout-session/".concat(tourId));
        case 1:
          session = _context.v;
          _context.n = 2;
          return getStripe();
...
if (updateUserData) updateUserData.addEventListener('submit', function (e) {
  e.preventDefault();
